...
const closeBtn = document.querySelector('.close'); if (closeBtn) closeBtn.onclick = () => closeModal('categoriesModal');

// Nouveaux boutons
const addTransBtn = document.getElementById('addTransactionBtn'); if (addTransBtn) addTransBtn.onclick = () => openTransactionModal('add');
const manageAccBtn = document.getElementById('manageAccountsBtn'); if (manageAccBtn) manageAccBtn.onclick = openAccountsModal;
const saveTransBtn = document.getElementById('saveTransactionBtn'); if (saveTransBtn) saveTransBtn.onclick = saveTransactionForm;
